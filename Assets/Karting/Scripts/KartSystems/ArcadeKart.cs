...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        void GroundAirbourne()
        {
            ...
            if (AirPercent >= 1)
            {
                Rigidbody.linearVelocity += Physics.gravity * Time.deltaTime * finalStats.AddedGravity;
            }
        }
        ...
        void MoveVehicle(float accelInput, float turnInput)
        {
            ...
            float accelRampT = Rigidbody.linearVelocity.magnitude / maxSpeed;
            ...
            Vector3 adjustedVelocity = Rigidbody.linearVelocity + movement * Time.deltaTime;

            adjustedVelocity.y = Rigidbody.linearVelocity.y;
            ...
            if (isCoasting)
            {
                Vector3 restVelocity = new Vector3(0, Rigidbody.linearVelocity.y, 0);
            ...
            if (GroundPercent > 0)
            {
                ...
                Rigidbody.linearVelocity = Quaternion.Euler(0f, turningPower * velocitySteering * Time.deltaTime, 0f) * Rigidbody.linearVelocity;
            }
            ...
            if (GroundPercent > 0f)
            {
                ...
                float latSpeed = Vector3.Dot(Rigidbody.linearVelocity, latFrictionDirection);
                // apply the damping
                Vector3 latFrictionDampedVelocity = Rigidbody.linearVelocity - latFrictionDirection * latSpeed * finalStats.Grip * gripCoeff * Time.deltaTime;

                // apply the damped velocity
                Rigidbody.linearVelocity = latFrictionDampedVelocity;
            }
        }
